...
// var sheetNamesArr = workBook.SheetNames;
// console.log(JSON.stringify(sheetNamesArr));
...
// var prefabSheet = workBook.Sheets['原始关卡配置'];
// getPrefab(prefabSheet, 92);
// var sortSheet = workBook.Sheets['微信手Q关卡配置表'];
// getSort(sortSheet, 85);


module.exports = function (lan, pf, prefabCount, sortCount, filePath, outDir) {
